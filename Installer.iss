...
; â”€â”€ Self-contained publish output (includes .NET runtime) â”€â”€
...
; â”€â”€ Shared ADLM env-var registration (reads ADLM_SHARED_* from the build
;    machine's environment at compile time; generates per-machine local
;    secrets at install time). â”€â”€
; This product ships offline licence validation, so a build without the
; shared secret must fail rather than warn. See AdlmEnvVars.iss.
#define AdlmRequireLicenseSecret
...
[Files]
; â”€â”€ Ship the entire self-contained build (includes .NET runtime + all DLLs) â”€â”€
...
; â”€â”€ ADLM RateGen environment variables â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
[Code]
{ Guards â€” skip writing empty ADLM_* env vars when the build machine has
...
begin
  ...
  begin
    { Local-only secrets â€” 32 random bytes (64 hex chars) is plenty. }
