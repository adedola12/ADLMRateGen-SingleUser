...
{
    public class BlockworkItem: INotifyPropertyChanged
    {
        private int _itemNo;
		...
		private ObservableCollection<BlockworkBreakdownLine> _blockworkBreakdownLines =
			new ObservableCollection<BlockworkBreakdownLine>();

		public ObservableCollection<BlockworkBreakdownLine> BlockworkBreakdownLine
		{
			get => _blockworkBreakdownLines;
			set
			{
				if (_blockworkBreakdownLines != value)
				{
					_blockworkBreakdownLines = value;
					OnPropertyChanged(nameof(BlockworkBreakdownLine));
				}
			}
		}
