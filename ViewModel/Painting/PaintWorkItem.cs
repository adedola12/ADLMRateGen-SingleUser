...
{
    public class PaintWorkItem: ViewModelBase
    {
        private int _itemNo;
        ...
        private ObservableCollection<PaintingBreakdownLine> _paintingBreakdownLines =
            new ObservableCollection<PaintingBreakdownLine>();
        public ObservableCollection<PaintingBreakdownLine> PaintingBreakdownLines
        {
            get => _paintingBreakdownLines;
            set
            {
                if(_paintingBreakdownLines != value)
                {
                    _paintingBreakdownLines = value;
                    OnPropertyChanged(nameof(_paintingBreakdownLines));
                }
            }
        }
