...
{
	public class GroundworkItem : INotifyPropertyChanged
	{
		private int _itemNo;
		...
		private ObservableCollection<GroundworkBreakdownLine> _breakdownLines =
			new ObservableCollection<GroundworkBreakdownLine>();
